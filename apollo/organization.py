...
class FundingEvent(BaseModel):
    """Apollo may return empty or partial funding event objects."""
...
class Account(BaseModel):
    """Apollo may return empty {} or partial account objects."""
    id: Optional[str] = Field(default=None, description="id")
...
class CurrentTechnology(BaseModel):
    """Apollo may return empty {} when no tech data."""
...
class IndustryTagHash(BaseModel):
    """Apollo may return {} or different keys. Extra keys allowed."""
...
class Organization(BaseModel):
    ...
    snippets_loaded: Optional[bool] = Field(default=None, description="snippets_loaded - Apollo may return null")
    industry_tag_id: Optional[str] = Field(default=None, description="industry_tag_id")
    industry_tag_hash: Optional[IndustryTagHash] = Field(default=None, description="industry_tag_hash")
    ...
    current_technologies: Optional[List[CurrentTechnology]] = Field(default=None, description="current_technologies")
    ...
    org_chart_removed: Optional[bool] = Field(default=None, description="org_chart_removed - Apollo may return null")
    org_chart_show_department_filter: Optional[bool] = Field(default=None, description="org_chart_show_department_filter - Apollo may return null")
    ...
    departmental_head_count: Optional[DepartmentalHeadCount] = Field(default=None, description="departmental_head_count")
