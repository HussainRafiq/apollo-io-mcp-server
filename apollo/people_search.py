...
class DialerFlags(BaseModel):
    """Apollo may return empty {} for dialer flags."""
...
class PhoneNumber(BaseModel):
    """Apollo may return empty or partial phone objects."""
...
class ContactEmail(BaseModel):
    """Apollo may return empty or partial contact email objects."""
...
class EmploymentHistory(BaseModel):
    """Apollo may return empty or partial employment objects."""
    id: Optional[str] = Field(default=None, description="id")
...
class Organization(BaseModel):
    """Apollo may return empty {} or partial org objects."""
    id: Optional[str] = Field(default=None, description="id")
    name: Optional[str] = Field(default=None, description="name")
    website_url: str = Field(description="website_url")
    blog_url: str = Field(description="blog_url")
...
class Contact(BaseModel):
    ...
    contact_emails: Optional[List[ContactEmail]] = Field(default=None, description="contact_emails")
    ...
    phone_numbers: Optional[List[PhoneNumber]] = Field(default=None, description="phone_numbers")
...
class Pagination(BaseModel):
    ...
    page: Optional[int] = Field(default=None, description="page")
    per_page: Optional[int] = Field(default=None, description="per_page")
    total_entries: Optional[int] = Field(default=None, description="total_entries")
    total_pages: Optional[int] = Field(default=None, description="total_pages")
