...
class EmploymentHistory(BaseModel):
    ...
    current: Optional[bool] = Field(default=True, description="current")
...
class Organization(BaseModel):
    """Apollo may return empty {} or partial org objects in person/contact responses."""
    id: Optional[str] = Field(default=None, description="id")
...
class Person(BaseModel):
    """Apollo may return partial person data when no match found."""
    id: Optional[str] = Field(default=None, description="id")
    first_name: str = Field(description="first_name")
    last_name: str = Field(description="last_name")
    name: str = Field(description="name")
